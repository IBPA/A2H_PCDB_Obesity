...
def run_hierarchical_clustering():
    ...
    inputs = inputs.drop(columns=[
        ...
        'preclinical_year', 'clinical_change_of_hba1c_value', 'preclinical_change_of_hba1c_value' # exclude these columns
    ], errors='ignore')
...
def run_biclustering():
    ...
    non_feature_cols = [
        ...
        'clinical_treatment_name', 'preclinical_treatment_name',
        'preclinical_year', 'clinical_change_of_hba1c_value', 'preclinical_change_of_hba1c_value'
    ]
