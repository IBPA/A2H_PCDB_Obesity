################################################################################
# LIRAGLUTIDE DIO DURATION ANALYSIS: LMER — RATS ONLY
#
# Estimand: does preclinical treatment duration predict the translational gap
# in liraglutide DIO studies, restricted to rat models?
#
...
# as DIO is excluded:
#   PMC5966539 (Goto-Kakizaki, rats, arm 170)
#   (arms 144 and 263 are mice-only and excluded automatically by the rats filter)
################################################################################
...
cat("================================================================================\n")
cat("LIRAGLUTIDE DIO DURATION ANALYSIS: LMER — RATS ONLY\n")
cat("================================================================================\n\n")
...
## =============================================================================
## Filter: Liraglutide, DIO model, rats only
## =============================================================================
...
cat("  arm 170 PMC5966539 (Goto-Kakizaki, rats)\n\n")

cat(sprintf("Liraglutide DIO rats dataset: %d observations, %d publications, %d clinical trials\n\n",
...
if (dur_term %in% rownames(coefs_final)) {
  ...
  if (!is.na(ref_p) && ref_p >= 0.05) {
    cat("-> NO SIGNIFICANT duration effect (Liraglutide DIO — Rats)\n\n")
  } else {
...
## --- Diagnostic plots ---
plot_file <- "lira_dio_duration_rats_lmer_robust_diagnostics.pdf"
...
if (dur_term %in% rownames(coefs_final)) {
  ...
  write.csv(result_row, "lira_dio_duration_rats_lmer_robust_summary.csv", row.names = FALSE)
  cat("Results saved to: lira_dio_duration_rats_lmer_robust_summary.csv\n\n")
  print(result_row)
}
...
cat("================================================================================\n")
cat("LIRAGLUTIDE DIO DURATION LMER ROBUST ANALYSIS (RATS ONLY) COMPLETE\n")
cat("================================================================================\n")
